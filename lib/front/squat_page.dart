...
class Squatstart extends StatefulWidget {
  final List<BluetoothService>? bluetoothServices;
  Squatstart({this.bluetoothServices});

  @override
  _SquatstartState createState() => _SquatstartState();
}

class _SquatstartState extends State<Squatstart> {
